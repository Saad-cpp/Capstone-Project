...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000,
                                                marks={0: '0', 100: '100', 2500: '2500', 5000: '5000', 7500:'7500'},
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df, values='class', names='Launch Site', title='Total successes')
        return fig
    else:
        filtered_df = filtered_df[filtered_df['Launch Site']== entered_site]
        #filtered_df['class'] = filtered_df['class'].astype(str)
        fig = px.pie(filtered_df, names='class', title='Successes by site')
        return fig
# TASK 4:
